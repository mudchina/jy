...
void relay_emote(object ob, string verb)
{
	...
	{
	command ("chat 胖胖儿快来啊，"+ ob->query("name") + "想要非礼我！\n") ;
   ...
   switch(random(50))
   {
    ...
    case 8:
    command("cry");
   command ("chat 胖胖快来啊，"+ ob->query("name") + "想要羞辱我！\n") ;
...
varargs void drool(string msg, string who)
{
	...
	if( (strsrch(msg, "kiss") >= 0)|| (strsrch(msg, "love") >= 0)|| (strsrch(msg, "吻") >= 0)
		...
		case 7:command ("chat 胖胖快来啊，"+ who + "想要羞辱我！\n") ;
		...
		case 15:command("chat 嗯，"+who+"是天底下最好的人了！\n"); break;
	                case 16:command ("chat 胖胖快来啊，"+ who + "欺负我！\n") ; break;
		}
		return;
	}
	...
	{	
		...
		case 11:command("chat* 李凌忽然大声说：打倒臭泥潭，打倒胖胖！\n"); break;
		case 12:command("chat* 李凌揉了揉哭红的眼睛，跺脚道： "+who+",我恨死你了！\n"); break;
		case 13:command ("chat 胖胖快来啊，"+ who + "又想要羞辱我！\n") ; break;
		}
	}
	...
	switch(random(80)) {
        ...
        case 26:	command ("chat 胖胖儿快来啊，"+ who + "又来欺侮我！\n") ; break;
	...
	{	
		...
		case 14:command("chat* 李凌摇了摇头，叹道：唉，真是世胖胖日下，人心不古啊！\n"); break;
		...
		switch(random(250)) {
			...
			case 39:command("chat* 李凌摇了摇头，叹道：唉，真是世胖胖日下，人心不古啊！\n"); break;
			...
			case 59:command("chat* 李凌忽然大声说：打倒臭泥潭，打倒胖胖！\n"); break;
...
int do_tell ( string arg )
{
   ...
   if( sscanf(arg, "liling %s", dir)==1 ) {
		...
		{
		command("tell "+ob->query("id")+" 你尽管自个儿爱吧。我就对胖胖还有点儿兴趣。");
...
int do_chat( string arg )
{
   ...
   if( sscanf(arg, "*kiss %s", dir)==1 ) {
		if( dir=="liling") {
		if(ob->query("id")=="jackyboy") return 0;
		else
		{
...
int accept_object(object me, object ob)
{
	...
	{
	message_vision("\n$N猛的扬起头，用惊喜的眼光看着$n，说：\n"
	+"咦，这不是胖胖送我的戒指吗，是他要你带来的么? 真谢谢你啊...\n",this_object(),me);
	}
	if ((string)ob->query("name")==HIW "水晶鞋" NOR) 
	{
	message_vision("\n$N猛的扬起头，用惊喜的眼光看着$n，说：\n"
	+"咦，这不是胖胖送我的吗水晶鞋吗，是他要你带来的么? 真谢谢你啊...\n",this_object(),me);
	}
	...
	{
	message_vision("\n$N缓缓地摇了摇头，柔声说道:不是胖胖送我的,我不要.\n"
	+"说罢垂下头来，咬了咬牙,幽幽嗔道：死胖胖，撑峙昼儿，为什么还不回来呢?\n",this_object());
	return 0;
	}
}
...
int do_kill(object me, object dest)
{
	...
	{
		message_vision(HIR "$N对$n说道：胖胖儿要我来杀你，对不起啊。。。\n"
			+RANK_D->query_rude(dest)+"，你就认命吧！\n" NOR, me, dest);
			if(wizardp(dest))		
	                { 
			dest->set("immortal",0);
...
int do_back(object me)
{
	...
	message("vision", "李凌走了进来，幽幽道：唉，胖胖儿真不乖，害得我又杀了人。\n", 
		environment(), me );
	me->set_leader(0);
	set("chat_chance", 3);
	set("chat_msg", ({
